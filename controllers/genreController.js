...
exports.genre_create_post = function(req, res, next) {
    ...
    //After trim, checkBody again to dissallow entries consisting entirely of spaces
    req.checkBody('name', 'Genre name cannot be made of spaces only').notEmpty();
...
exports.genre_update_get = function(req, res, next) {
    async.parallel({
      ...
      if (err) { return next(err); }
      res.render('genre_form', { title: 'Genre Update', genre: results.genre, genre_books: results.genre_books } );
    });
};
